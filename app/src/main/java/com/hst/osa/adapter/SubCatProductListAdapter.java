...
public class SubCatProductListAdapter extends RecyclerView.Adapter<SubCatProductListAdapter.MyViewHolder> {
...
//            }
    ...
    public SubCatProductListAdapter(ArrayList<Product> newsFeedArrayList, OnItemClickListener onItemClickListener) {
