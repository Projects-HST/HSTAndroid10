...
//            }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new OrderHistoryDetailListAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(OrderHistoryDetailListAdapter.MyViewHolder holder, int position) {
